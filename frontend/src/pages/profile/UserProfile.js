...
function UserProfile() {
  ...
  const editableForm = async (e) => {
    ...
    try {
      ...
      const resp = await axios.put(`${BASE_API}/userinfoupdate`, request, config);
      if (resp.status === 200) {
      ...
      <div className="row">
        ...
        <div className="col-lg-8">
          <div className="">
            ...
            <div className="card mb-3" style={{ backgroundColor: "#F7FAFA" }}>
          ...
          <button className="btn btn-outline-primary btn-sm" onClick={showUpdateField}>
            Edit profile
          </button>
        </div>
      </div>
